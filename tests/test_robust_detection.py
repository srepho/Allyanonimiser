...
class TestRobustDetection:
    ...
    def test_validator_functions(self):
        ...
        assert not EntityValidator.validate_date("NSW 2000")[0]
        assert EntityValidator.validate_date("15/01/2023")[0]
        assert not EntityValidator.validate_date("0412")[0]  # Phone prefix

        # Test phone validation
        assert EntityValidator.validate_phone_number("0412345678")[0]
        assert not EntityValidator.validate_phone_number("123")[0]

        # Test Medicare validation
        assert EntityValidator.validate_medicare_number("2123456781")[0]
        assert not EntityValidator.validate_medicare_number("1123456781")[0]
